...
export default function TodoLandingPage() {
    ...
    return (
        <Fragment>
            ...
            <div className="bg-slate-950 from-slate-900 via-indigo-950 to-slate-900 text-slate-100 flex flex-col justify-between">
                {/* Adding the Navbar */}
                <Navbar />

                {/* Hero / Header Section */}
                <header className="max-w-4xl w-full mx-auto px-4 pt-12 pb-6 text-center py-16">
                ...
                <main className="flex-grow max-w-2xl w-full mx-auto px-4 py-6 mb-[100px]">
